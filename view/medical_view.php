...
<script>
    function editEvent(eventId) {
        ...
        window.location.href = "../controller/edit_medical.php?id=" + eventId;
    }
    ...
    function deleteEvent(eventId) {
        ...
        if (confirmation) {
            ...
            xhttp.open("GET", "../controller/delete_medical.php?id=" + eventId, true);
            xhttp.send();
        }
    }
    ...
    function addEvent() {
        ...
        window.location.href = "../controller/add_medical.php";
    }
</script>
</body>
</html>
